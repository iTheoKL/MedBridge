...
### Frontend / Dashboard UI — Theo ([@iTheoKL](https://github.com/iTheoKL))
...
### Symptom Tracking — Theo ([@iTheoKL](https://github.com/iTheoKL))
...
### Authentication & Theming — Theo ([@iTheoKL](https://github.com/iTheoKL))
...
### Deployment — Theo ([@iTheoKL](https://github.com/iTheoKL))
...
1–2. **Theo** — Initial commit; expand README with key features
3–6. **vajahath** — Implement MedBridge OCR API with image upload + supporting files
7–12. **Theo** — index.html, style.css, script.js, nav/user-menu enhancements
13–14. **jeevan** — Medication details/interaction script + interaction database
15–16. **Theo** — Update README with progress + correct contributor names
...
24. **Theo** — Enhance README with project details
...
29. **Theo** — Update README.md
30. **Theo** — Add requirements.txt
31–32. **dhinakaran** — Update reminders.html refs; trim medications.html
33. **Theo** — Add preload_models.py
34–35. **Theo** — Add symptoms.html, js/symptoms.js
36. **Theo** — Update README with symptom tracking and deployment info
37. **Theo** — Create database/placeholder.md
38. **Theo** — Add drug database
39–42. **Barath / Theo** — Rename/relocate medications.csv into database/
43–44. **Theo** — Add files via upload
45. **Theo** — Refactor CSS variables and styles for consistency
46. **Theo** — Add files via upload
47–51. **Theo** — Refactor medications.html, ocr.html, reminders.html, report.html, symptoms.html (styling/layout cleanup)
52. **Theo** — Add files via upload
53. **Theo** — Enhance theme support with new CSS variables
54. **Theo** — Add files via upload
55. **Theo** — Change logout redirect to login.html
56. **Theo** — Update print statement from 'Hello' to 'Goodbye'
57. **Theo** — Update script.js
58. **Theo** — Add .vercelignore
59–67. **Theo** — Roll out theme + auth guard scripts across account, index, logout, medications, OCR (+ camera capture), reminders, report, and symptoms pages
68. **Theo** — Modify symptoms.js (add Paracetamol/Aspirin entries)
69. **Theo** — Update print statement from 'Hello' to 'Goodbye' (symptoms.js)
70. **Theo** — Update medication reminders and interaction details
71. **Theo** — Add current medications section to report
72. **Theo** — Refactor report.js for improved report handling
73. **Theo** — Change toast and theme-toggle positions in CSS
74. **Theo** — Add new medications to the medication list
75. **Theo** — Enhance comments in symptoms.js for clarity
76. **Theo** — Clarify medication list synchronization in report.js
